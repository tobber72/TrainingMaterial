...
namespace CarRental.Web.Controllers.API
{
    ...
    public class ReservationApiController : ApiControllerBase
    {
        ...
        protected override void RegisterServices(List<IDisposable> disposableServices)
        {
            disposableServices.Add(_InventoryService as IDisposable);
            disposableServices.Add(_RentalService as IDisposable);
        }
