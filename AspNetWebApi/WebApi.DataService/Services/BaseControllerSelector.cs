...
namespace WebApi.DataService.Services
{
    /// <summary>
    /// BaseControllerSelector contains methods that help with versioning of WebApi service.
    ...
    /// 
    /// Todo - Update the SelectController with the versioning method you care about.
    /// </summary>
    public class BaseControllerSelector : DefaultHttpControllerSelector
    {

        private HttpConfiguration _config;
        public BaseControllerSelector(HttpConfiguration config)
            : base(config)
        {
            _config = config;
        }
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            {
                // Uncomment the versioning method you care about.
        ...
        {
            const string HEADER_NAME = "X-IhcWebApi-Version";
